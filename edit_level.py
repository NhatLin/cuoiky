...
platform_x_img = pygame.image.load('img/landxy.png')
platform_y_img = pygame.transform.flip(platform_x_img, False, True)
poison_img = pygame.image.load('img/poison.png')
coin_img = pygame.image.load('img/coin (3).png')
		...
		for col in range(20):
			if world_data[row][col] > 0:
				...
				if world_data[row][col] == 6:
					#lava
					img = pygame.transform.scale(poison_img, (tile_size, tile_size // 2))
